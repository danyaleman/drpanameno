...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0">✅ Citas Completadas</h4>
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="{{ url('/dashboard') }}">Dashboard</a></li>
                    <li class="breadcrumb-item active">Citas Completadas</li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <ul class="nav nav-pills nav-justified gap-2 px-0" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link rounded-pill d-flex align-items-center justify-content-center gap-2 py-2 active"
                   ...
                   style="background: linear-gradient(135deg,#28a745,#1e7e34); color: #fff; font-weight: 600; font-size: 0.85rem; border: none;">
...
<div class="card border-0 shadow-sm">
    <div class="card-header d-flex align-items-center justify-content-between py-3"
        ...
        <div class="d-flex align-items-center">
            <i class="bx bx-check-circle text-white font-size-20 me-2"></i>
            <h5 class="mb-0 text-white fw-bold">Citas Completadas</h5>
        </div>
    ...
    <div class="card-body p-0">
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    @forelse ($Complete_appointment as $item)
                    <tr class="border-bottom">
                        {{-- Paciente con avatar --}}
                        <td class="ps-4 py-3">
                            <div class="d-flex align-items-center">
                                <div class="avatar-sm me-3 flex-shrink-0">
                                    <div class="avatar-title rounded-circle bg-success-subtle text-success fw-bold">
                        ...
                        {{-- Hora --}}
                        <td class="py-3">
                            <span class="badge bg-success-subtle text-success rounded-pill px-3" style="font-size:0.95rem;">
                    ...
                    <tr>
                        <td colspan="5" class="text-center py-5">
                            <div class="text-muted">
                                <i class="bx bx-check-circle font-size-48 d-block mb-3 text-success opacity-50"></i>
                                <p class="mb-2 fw-medium">No hay citas completadas</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
    ...
    @if($Complete_appointment->hasPages())
    <div class="card-footer bg-white d-flex align-items-center justify-content-between">
        <small class="text-muted">
            Mostrando {{ $Complete_appointment->firstItem() }} a {{ $Complete_appointment->lastItem() }} de {{ $Complete_appointment->total() }} registros
        </small>
