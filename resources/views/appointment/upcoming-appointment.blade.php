...
@section('title') {{ __('Citas Futuras') }} @endsection
...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0">🗓️ Citas Futuras</h4>
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="{{ url('/dashboard') }}">Dashboard</a></li>
                    <li class="breadcrumb-item active">Citas Futuras</li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <ul class="nav nav-pills nav-justified gap-2 px-0" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link rounded-pill d-flex align-items-center justify-content-center gap-2 py-2 active"
                   ...
                   style="background: linear-gradient(135deg,#17a2b8,#117a8b); color: #fff; font-weight: 600; font-size: 0.85rem; border: none;">
...
<div class="card border-0 shadow-sm">
    <div class="card-header d-flex align-items-center justify-content-between py-3"
        ...
        <div class="d-flex align-items-center">
            <i class="bx bx-calendar-event text-white font-size-20 me-2"></i>
            <h5 class="mb-0 text-white fw-bold">Citas Futuras</h5>
        </div>
    ...
    <div class="card-body p-0">
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    @forelse ($Upcoming_appointment as $item)
                    @php
                    ...
                    <tr class="border-bottom">
                        ...
                        <td class="ps-4 py-3">
                            <div class="d-flex align-items-center">
                                <div class="avatar-sm me-3 flex-shrink-0">
                                    <div class="avatar-title rounded-circle bg-info-subtle text-info fw-bold">
                        ...
                        <td class="py-3">
                            ...
                            @elseif($daysUntil > 1 && $daysUntil <= 7)
                                <span class="badge bg-info-subtle text-info ms-1 small">En {{ $daysUntil }} días</span>
                            @endif
                        </td>
                        {{-- Hora --}}
                        <td class="py-3">
                            <span class="badge bg-info-subtle text-info rounded-pill px-3" style="font-size:0.95rem;">
                    ...
                    <tr>
                        <td colspan="5" class="text-center py-5">
                            <div class="text-muted">
                                <i class="bx bx-calendar-event font-size-48 d-block mb-3 text-info opacity-50"></i>
                                <p class="mb-2 fw-medium">No hay citas futuras programadas</p>
    ...
    @if($Upcoming_appointment->hasPages())
    <div class="card-footer bg-white d-flex align-items-center justify-content-between">
        <small class="text-muted">
            Mostrando {{ $Upcoming_appointment->firstItem() }} a {{ $Upcoming_appointment->lastItem() }} de {{ $Upcoming_appointment->total() }} registros
        </small>
