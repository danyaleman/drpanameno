                    ...
                    @if ($role == 'doctor')
                        <a href="{{ url('/dashboard') }}">
                            <button type="button" class="btn btn-primary waves-effect waves-light mb-4">
                                <i
                                    class="bx bx-arrow-back font-size-16 align-middle me-2"></i>{{ __('Regresar al Dashboard') }}
                            </button>
                        </a>
                    @else
                        <a href="{{ url('doctor/' . $doctor->id) }}">
                            <button type="button" class="btn btn-primary waves-effect waves-light mb-4">
                                <i
                                    class="bx bx-arrow-back font-size-16 align-middle me-2"></i>{{ __('Regresar al Perfil') }}
                            </button>
                        </a>
                    @endif
                @else
                    <a href="{{ url('doctor') }}">
                        <button type="button" class="btn btn-primary waves-effect waves-light mb-4">
                            <i
                                class="bx bx-arrow-back font-size-16 align-middle me-2"></i>{{ __('Regresar a la Lista de Doctores') }}
                        </button>
                    </a>
                @endif
            </div>
                        ...
                        <form action="{{ url('profile-update') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <input type="text"
                                                ...
                                                placeholder="{{ __('Ingresa Nombres') }}">
                                            @error('first_name')
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <input type="text"
                                                ...
                                                placeholder="{{ __('Ingresar Experiencia') }}">
                                            @error('experience')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                            ...
                                            <div class="col-md-12 mb-3">
                                                ...
                                                @error('mon')
                                                    <span class="error d-block " role="alert">
                                                        <strong>Selecciona al menos un día</strong>
                                                    </span>
                                                @enderror
                                            </div>
                                        @endif
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <input type="text" class="form-control @error('last_name') is-invalid @enderror"
                                                ...
                                                placeholder="{{ __('Ingresar Apellidos') }}">
                                            @error('last_name')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            <label class="form-label">{{ __('Telefono de Contacto ') }}<span
                                                    class="text-danger">*</span></label>
                                            <input type="tel" class="form-control @error('mobile') is-invalid @enderror"
                                                name="mobile" id="patientMobile" tabindex="4"
                                                value="{{ old('mobile', $doctor->mobile) }}"
                                                placeholder="{{ __('Ingresar Telefono de Contacto') }}">
                                            @error('mobile')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            <label class="form-label">{{ __('Titulos ') }}<span
                                                    class="text-danger">*</span></label>
                                            <input type="text" class="form-control @error('degree') is-invalid @enderror"
                                                ...
                                                placeholder="{{ __('Ingresar Titulos') }}">
                                            @error('degree')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
