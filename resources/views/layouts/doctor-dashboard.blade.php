    ...
    <div class="col-xl-4">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <div class="pt-4">
                            <div class="row">
                                <div class="col-12">
                                    <h5 class="font-size-12">{{ __('Última conexión:') }}</h5>
                            ...
                            <div class="row mt-4">
                                <div class="col-12">
                                    ...
                                    <a href="{{ url('time-edit/' . $user->id) }}"
                                        class="btn btn-primary waves-effect waves-light btn-sm">{{ __('Disponibilidad') }}
                                        <i class="mdi mdi-arrow-right ms-1"></i></a>
                                </div>
                            </div>
                        </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <p class="text-muted">{{ __('Mes actual') }}</p>
                        ...
                        <p class="text-muted"><span class="@if ($data['monthly_diff'] > 0) text-success @else text-danger @endif me-2"> {{ $data['monthly_diff'] }}% <i class="mdi @if ($data['monthly_diff'] > 0) mdi-arrow-up @else mdi-arrow-down @endif"></i> </span>
                            {{ __('A comparación del mes anterior') }}</p>
                    </div>
                    <div class="col-sm-6">
