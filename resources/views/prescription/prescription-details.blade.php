            ...
            <div class="tab-pane fade" id="tab-consulta">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="codigo_id" id="codigo_id" class="form-select" disabled>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="precio_consulta" id="precio_consulta"
                                        ...
                                        style="border-left:none; color:#198754;">
                                </div>
                        ...
                        <div id="precio-resumen" class="mt-3 p-3 rounded-3 d-none"
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        <div class="d-flex align-items-center justify-content-between mb-1">
                            <label class="form-label fw-semibold text-dark mb-0">
                                <i class="bx bx-history me-1 text-purple"></i> Historia Clínica
                        ...
                        <textarea name="diagnosis" id="diagnosis" class="form-control" rows="5"
                            placeholder="Resumen de antecedentes relevantes, evolución del padecimiento, procedimientos previos, tratamientos anteriores..."></textarea>
...
$(document).ready(function () {
    ...
    if (tipoSelect) {
        tipoSelect.addEventListener('change', function () {
            ...
            .finally(() => {
                codigoLoading.style.display = 'none';
                actualizarResumen();
            });
        });
    ...
    document.querySelectorAll('.btn-mic').forEach(btn => {
        ...
        btn.addEventListener('click', () => {
            ...
            rec.onresult = (e) => {
                ...
                // Mostrar en tiempo real: base + todo lo final + lo interim actual
            ...
            rec.onend = () => {
                // Conservar TODO lo acumulado: base + final + cualquier interim pendiente
                const fullText = textarea.value; // ya tiene base+final+interim desde onresult
                textarea.value = fullText.trim() ? fullText : (baseText + finalText);
                // Disparar evento input/change para que frameworks detecten el cambio
