            ...
            <div class="card shadow-sm border-0 mb-3" style="border-radius: 10px;">
                ...
                <div class="card-footer bg-light" style="border-radius: 0 0 10px 10px;">
                    ...
                    <div class="input-group input-group-sm">
                        <input type="text" class="form-control" id="telemed-url" value="{{ optional(optional($prescription->appointment)->teleconsultation)->daily_room_url }}" readonly>
                    ...
                    <script>
                        function openFloatingWindow() {
                            var url = "{{ url('/telemedicine/room/' . optional(optional($prescription->appointment)->teleconsultation)->id) }}?iframe=1";
